const Contact = () => {
  return (
    <div id='contact' className='w-full h-screen px-8 md:px-0 py-4 overflow-hidden flex flex-col gap-8 items-center justify-center'>
      ...
      <form action="" className="md:w-2/4 w-full px-4 md:px-8 py-8 rounded-xl border border-gold flex flex-col gap-4" data-aos="zoom-in">
        ...
        <button data-aos="fade-down" className="bg-gold border-2 hover:bg-transparent hover:border-gold hover:text-gold border-primary py-4 rounded-xl">Send</button>
      </form>
    </div>
  )
}
